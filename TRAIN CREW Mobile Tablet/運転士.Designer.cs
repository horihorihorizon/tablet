namespace test
{
    partial class M
    {
        ...
        private void InitializeComponent()
        {
            ...
            controlScalerProvider1.SetFontResizable(button1, false);
            button1.ForeColor = Color.Black;
            button1.Location = new Point(12, 12);
            controlScalerProvider1.SetMovable(button1, true);
            button1.Name = "button1";
            controlScalerProvider1.SetRefLocation(button1, new Point(0, 0));
            controlScalerProvider1.SetResizableX(button1, false);
            controlScalerProvider1.SetResizableY(button1, false);
            ...
            controlScalerProvider1.SetFontResizable(pictureBox2, false);
            ...
            controlScalerProvider1.SetResizableX(pictureBox2, true);
            controlScalerProvider1.SetResizableY(pictureBox2, true);
            ...
            controlScalerProvider1.SetFontResizable(comboBox1, false);
            comboBox1.FormattingEnabled = true;
            comboBox1.Items.AddRange(new object[] { "0709", "1113", "1517", "1820", "2123", "ダイヤ不定" });
            ...
            controlScalerProvider1.SetResizableX(comboBox1, false);
            controlScalerProvider1.SetResizableY(comboBox1, false);
            ...
            controlScalerProvider1.SetFontResizable(comboBox2, false);
            comboBox2.FormattingEnabled = true;
            comboBox2.Items.AddRange(new object[] { "平1", "平2", "平3", "平4", "平5", "平6", "平7", "平8", "平9", "平10", "平11", "平12", "平13", "平14", "平151", "平152", "平153", "平154", "平155", "平156", "平157", "平158", "平159", "平160", "平161", "平162", "平566", "変-平5", "変-平9", "変-平13", "変-平151", "普変-平1", "普変-平2", "普変-平7", "普変-平8", "準変-平3", "準変-平4", "準変-平5", "準変-平6", "準変-平11", "準変-平12", "地変-平1", "地変-平2", "地変-平4", "地変-平5", "地変-平7", "地変-平8", "地変-平10", "地変-平21", "地変-平22", "地変-平23", "地変-平24", "地変-平15", "地変-平26", "地変-平27", "特変-平551", "特変-平552", "教変-平151", "教変-平157", "教変-平551", "教変-平552", "臨-平848", "臨-平849" });
            ...
            controlScalerProvider1.SetResizableX(comboBox2, false);
            controlScalerProvider1.SetResizableY(comboBox2, false);
            ...
            controlScalerProvider1.SetFontResizable(button2, false);
            ...
            controlScalerProvider1.SetResizableX(button2, false);
            controlScalerProvider1.SetResizableY(button2, false);
            ...
            controlScalerProvider1.SetFontResizable(pictureBox1, false);
            ...
            controlScalerProvider1.SetResizableX(pictureBox1, true);
            controlScalerProvider1.SetResizableY(pictureBox1, true);
            pictureBox1.Size = new Size(282, 399);
            ...
            controlScalerProvider1.SetFontResizable(comboBox3, false);
            ...
            controlScalerProvider1.SetResizableX(comboBox3, true);
            controlScalerProvider1.SetResizableY(comboBox3, false);
            ...
            controlScalerProvider1.SetFontResizable(button4, false);
            button4.Location = new Point(633, 11);
            controlScalerProvider1.SetMovable(button4, true);
            button4.Name = "button4";
            controlScalerProvider1.SetRefLocation(button4, new Point(0, 0));
            controlScalerProvider1.SetResizableX(button4, true);
            controlScalerProvider1.SetResizableY(button4, false);
            ...
            controlScalerProvider1.SetFontResizable(button5, false);
            button5.Location = new Point(713, 11);
            controlScalerProvider1.SetMovable(button5, true);
            button5.Name = "button5";
            controlScalerProvider1.SetRefLocation(button5, new Point(0, 0));
            controlScalerProvider1.SetResizableX(button5, true);
            controlScalerProvider1.SetResizableY(button5, false);
            ...
            controlScalerProvider1.SetFontResizable(button6, false);
            ...
            controlScalerProvider1.SetResizableX(button6, false);
            controlScalerProvider1.SetResizableY(button6, false);
            ...
            controlScalerProvider1.SetFontResizable(button7, false);
            ...
            controlScalerProvider1.SetResizableX(button7, false);
            controlScalerProvider1.SetResizableY(button7, false);
            ...
            controlScalerProvider1.SetFontResizable(button8, false);
            ...
            controlScalerProvider1.SetResizableX(button8, false);
            controlScalerProvider1.SetResizableY(button8, false);
            ...
            controlScalerProvider1.SetMovable(this, true);
            Name = "M";
            controlScalerProvider1.SetRefLocation(this, new Point(0, 0));
            controlScalerProvider1.SetResizableX(this, true);
